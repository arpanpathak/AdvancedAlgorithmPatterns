...
| 7.12 | Find Score After Marking | min-heap lazy skip | $O(n log n)$ | [→](find-score-of-an-array-after-marking.md) |
| 7.13 | Finding MK Average | three-bucket heaps | $O(log m)$ | [→](finding-mk-average.md) |
