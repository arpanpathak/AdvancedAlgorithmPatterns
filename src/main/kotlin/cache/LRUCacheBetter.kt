...
class LRUCacheLL<K, V>(private val capacity: Int) {
...
// Test LRU Cache
fun main() {
    val cache = LRUCacheLL<Int, String>(2)

    cache.put(1, "A")
    cache.put(2, "B")
    println("Get 1: ${cache.get(1)}") // Should print "A"

    cache.put(3, "C") // Evicts key 2
    println("Get 2: ${cache.get(2)}") // Should print null

    cache.put(4, "D") // Evicts key 1
    println("Get 1: ${cache.get(1)}") // Should print null
    println("Get 3: ${cache.get(3)}") // Should print "C"
    println("Get 4: ${cache.get(4)}") // Should print "D"
}